...
module snippet (
    input wire clk,
    input wire [3:0] inj_dffcl_ctrl_mode_1755004211791_773,
    input wire [15:0] inj_dffcl_data_in1_1755004211791_861,
    input wire [15:0] inj_dffcl_data_in2_1755004211791_526,
    input wire reset,
    output logic [15:0] inj_dffcl_data_out_1755004211791_296
);
    deep_ff_control_logic deep_ff_control_logic_inst_1755004211791_7394 (
        .dffcl_rst_n(reset),
        .dffcl_data_out(inj_dffcl_data_out_1755004211791_296),
        .dffcl_clk(clk),
        .dffcl_ctrl_mode(inj_dffcl_ctrl_mode_1755004211791_773),
        .dffcl_data_in1(inj_dffcl_data_in1_1755004211791_861),
        .dffcl_data_in2(inj_dffcl_data_in2_1755004211791_526)
    );
endmodule
